...
![AWS deployment architecture: Amplify -> API Gateway -> EC2 (VPC, public subnet) -> S3 (sparse search), S3 Vectors (dense search), Secrets Manager, Systems Manager, and CloudWatch, with EC2 calling the external Groq LLM API](/images/2-Proposal/rag_diagram.png)
